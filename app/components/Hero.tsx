      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-6 text-gray-300 max-w-2xl">
            Hello! I’m a passionate researcher and engineer with a strong
            academic foundation and keen interest in computer science. I enjoy
          ...
          <div className="mt-8">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-1">
              ...
              <li>
                B.Tech – Krishna Institute of Technology, Kanpur – 2009–2013
              </li>
